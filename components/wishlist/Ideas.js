      ...
      <ul>
        <li>
          ...
          <p>
            ...
            <a target="_blank" href="https://steamcommunity.com/id/deadtrace/">
              Steam аккаунте
            </a>
        ...
        <li>
          ...
          <p>
            ...
            "Зенит", в NBA - Boston Celtics. Любимый игрок - Гордон Хэйворд
            (Gordon Hayward). Люблю посещать баскетбольные матчи ("Зенита"
            прежде всего), не против был бы когда-нибудь сгонять на выезд.
            Баскетбольной атрибутики почти никакой нет, к сожалению. Не
            отказался бы от какого-нибудь джерси либо Хэйворда, либо бостонского
            игрока (#7 Jaylen Brown, e.g.). Либо же хорошие баскетбольные
            кроссовки. У Гордона Хэйворда есть именная линейка кроссовок вместе
            с Anta, у меня есть Anta GH1, нет Anta GH2. Ещё очень крутые Nike
            Lebron XVIII, Nike Air Zoom BB NXT. Мой размер - US 10,5-11, длина
            стопы - 28,5.
          </p>
          <div className={css["image-container"]}>
            <Image
